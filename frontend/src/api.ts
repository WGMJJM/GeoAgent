...
export type TokenUsage = { local_input_tokens: number; local_output_tokens: number; reported_input_tokens: number; reported_output_tokens: number; model_calls: number; reported_calls: number };
export type Run = { id: string; parent_run_id?: string | null; conversation_id?: string | null; task_id?: string | null; agent_id: string; status: RunStatus; started_at?: string | null; finished_at?: string | null; error?: string | null; turn_count: number; tool_call_count: number; token_usage?: TokenUsage | null; metadata: RunMetadata };
